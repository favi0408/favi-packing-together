        ...
        {!minimal && (
          <>
            ...
            <div>
              ...
              <div className="px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-800/50 text-blue-600 dark:text-blue-400 font-semibold text-sm">
